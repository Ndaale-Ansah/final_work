        ...
        <ul class="filters_menu">
          ...
          <?php 
            ...
            foreach($categories as $category){
              echo "<li data-filter='.{$category['cat_name']}'>{$category['cat_name']}</li>"; 
            }
          ?>
        </ul>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="detail-box">
              ...
              <p>
              Open day by day for lunch and dinner,Gracyln offers a choice of naturally arranged things utilizing just the best fixings accessible. Top picks incorporate Certified Angus Beef®, crisp fish, rotisserie chicken, infant back pork ribs.
              </p>
              <a href="./about.php">
                Read More
              </a>
